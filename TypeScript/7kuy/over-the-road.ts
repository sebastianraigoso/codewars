...
// Given your house number address and length of street n, give the house number on the opposite side 
// of the street.
...
// If you try to store the addresses of 500 billion houses in a list then you will run out of memory 
