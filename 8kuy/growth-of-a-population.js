...
// At the end of each year, the population count is an integer: 252.8 people round down to 252 persons.
...
function nbYear(p0, percent, aug, p) {
    ...
    for(let i; countPop < p; i++) {
        countPop += Math.floor(countPop * (percent / 100) + aug)
        countYears++
    }
    return countYears
}
