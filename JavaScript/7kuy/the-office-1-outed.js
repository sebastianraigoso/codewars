...
function outed(meet, boss) {
  const teamLength = Object.entries(meet).length // 11
  const rating = Object.values(meet).reduce((a, c) => a + c, 0) + meet[boss]
  return rating / teamLength <= 5 ? "Get Out Now!" : "Nice Work Champ!"
}
